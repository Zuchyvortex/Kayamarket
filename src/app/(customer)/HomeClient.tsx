...
export default function HomeClient({ initialProducts, initialCategories, homepageConfig }: { initialProducts: any[], initialCategories: any[], homepageConfig: any }) {
  ...
  const filteredProducts = activeCategory === "all" 
    ...
    : initialProducts.filter(p => p.categorySlug === activeCategory).slice(0, 8);
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 space-y-6 text-center lg:text-left">
              ...
              <p className="text-sm text-white/80 max-w-sm mx-auto lg:mx-0">
                {homepageConfig?.announcementActive ? homepageConfig.announcementText : "Massive discounts on premium foodstuff packages. Grab fresh supplies at wholesale prices before the timer runs out!"}
              </p>
