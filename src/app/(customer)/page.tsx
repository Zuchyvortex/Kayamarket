      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-kaya-black via-slate-900 to-kaya-black text-white pt-16 pb-20 md:pt-24 md:pb-28 px-4 sm:px-6 lg:px-8 border-b border-slate-800">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center space-x-2 bg-kaya-green/10 text-kaya-green px-4.5 py-2 rounded-full text-xs font-bold uppercase tracking-widest border border-kaya-green/20 animate-fade-in-up">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-800 max-w-lg mx-auto lg:mx-0">
              ...
              <div>
                <p className="text-2xl font-black text-kaya-green">100%</p>
                ...
                >
                  ...
                  <div className="mt-4 space-y-1">
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-black text-kaya-green uppercase tracking-widest">{product.categorySlug}</span>
              ...
              <div className="flex flex-col justify-between flex-1 py-1">
                ...
                <div className="flex justify-between items-center mt-6 pt-3 border-t border-slate-50 dark:border-slate-800/50">
                  ...
                  <button 
                    ...
                    className="bg-kaya-green hover:bg-green-700 text-white font-bold px-5 py-2.5 rounded-xl text-xs flex items-center gap-1.5 transition-colors shadow-md hover:shadow-green-500/10"
                  >
            ...
            <div key={i} className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 dark:border-slate-800/80 overflow-hidden shadow-[0_4px_25px_rgba(0,0,0,0.01)] hover:shadow-[0_25px_50px_rgba(0,0,0,0.08)] transition-all duration-300 group flex flex-col justify-between">
              ...
              <div className="p-8 pt-0 flex justify-between items-center border-t border-slate-50 dark:border-slate-800/50">
                ...
                <button 
                  ...
                  className="bg-kaya-green hover:bg-green-700 text-white font-bold px-6 py-3.5 rounded-2xl shadow-md hover:shadow-green-500/20 transition-all text-xs flex items-center space-x-2"
                >
                ...
                <div className="flex-1 bg-slate-950 rounded-[2rem] p-4 flex flex-col justify-between border border-slate-800 overflow-hidden relative">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center border-b border-slate-800 pb-2">
                      ...
                      <span className="text-[8px] font-black text-kaya-green bg-green-500/10 px-2 py-0.5 rounded">Active</span>
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-sm text-slate-600 dark:text-slate-400 font-semibold">
              ...
              <div className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-kaya-green" />
